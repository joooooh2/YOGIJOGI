...
$(function(){
	...
	/* 음식점 등록 시작 */
	document.getElementById('insertRstrntBtn').addEventListener('click', function(){
		// 입력 정보 가져오기
		...
		if(rstrntAddr == "" ||
			...
			rstrntPrkplce == "" ||
			rstrntResve == ""){
			Swal.fire('음식점 등록 실패!', '음식점 정보를 모두 입력해 주세요.', 'error');
			return;
		}
		
		// 사진을 미첨부했을 시 등록 불가 처리
		if(uploadFile == null){
			Swal.fire('음식점 등록 실패!', '사진을 업로드해 주세요.', 'error');
			return;
		}
		...
		$.ajax({
			...
			dataType: "text",
			success: function(res){
				confirmAlert2('음식점이 등록되었습니다.', '', 'success');
			}
		});	// end ajax
	});
	/* 음식점 등록 끝 */
                    ...
                    <form action="#">
                        <div class="row" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 10px; padding: 40px 45px;">
                        	<div class="col-lg-12 insert-rstrnt-title" style="margin-bottom: 35px;">
                        		<h3 style="text-align: center; font-weight: 600; color: #555; letter-spacing: -2px;">음식점 등록</h3>
                        	</div>
							<div class="col-lg-10">
								<input type="text" id="rstrntAddr" class="form-control" placeholder="음식점주소" required style="color: #ddd;">
							</div>
							...
							<div class="col-lg-6">
                                <input type="text" id="rstrntNm" name="rstrntNm" class="form-control" placeholder="음식점명" required>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <input type="text" id="rstrntTel" class="form-control" placeholder="음식점 전화번호" required>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" id="rstrntBsnTm" class="form-control" placeholder="음식점 영업시간" required>
                            </div>
                            <div class="col-lg-12">
                                <input type="text" id="rstrntMenu" class="form-control" placeholder="음식점 대표 메뉴" required style="height: 40px;">
                            </div>
                            <div class="col-lg-12">
                                <textarea id="rstrntDscrp" class="form-control" rows="6" placeholder="음식점 상세 설명" required style="resize: none;"></textarea>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" id="rstrntPrkplce" class="form-control" placeholder="주차장 유무" required>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" id="rstrntResve" class="form-control" placeholder="예약 관련 정보">
                            </div>
                            ...
                            <div class="col-lg-12" style="text-align: center; margin-top: 10px;">
	                            <input id="insertRstrntBtn" type="button" value="등록" style="">
                            </div>
                        </div>
                    </form>
                </div>
